...
public class AlipaySubmit {
     ...
     */
    private static final String ALIPAY_GATEWAY_NEW = AlipayConfig.alipay_gateway_url;
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>支付宝即时到账交易接口</title></head><body>");
