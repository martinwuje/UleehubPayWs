 ...
 */
package com.uleehub.common.repository;

import com.uleehub.common.entity.search.Searchable;
import com.uleehub.common.repository.callback.SearchCallback;
...
public class RepositoryHelper {
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[com.uleehub.common.repository.RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see com.uleehub.common.repository.callback.DefaultSearchCallback}<br/>
     * <p/>
     * 测试用例请参考：{@see com.uleehub.common.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see com.uleehub.common.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.uleehub.common.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.uleehub.common.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：com.uleehub.common.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see com.uleehub.common.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return
