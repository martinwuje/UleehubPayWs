 ...
 */
package com.uleehub.common.entity.search.utils;

import com.google.common.collect.Lists;
import com.uleehub.common.entity.search.SearchOperator;
import com.uleehub.common.entity.search.Searchable;
import com.uleehub.common.entity.search.exception.InvalidSearchPropertyException;
import com.uleehub.common.entity.search.exception.InvalidSearchValueException;
import com.uleehub.common.entity.search.exception.SearchException;
import com.uleehub.common.entity.search.filter.AndCondition;
import com.uleehub.common.entity.search.filter.Condition;
import com.uleehub.common.entity.search.filter.OrCondition;
import com.uleehub.common.entity.search.filter.SearchFilter;
import com.uleehub.common.utils.SpringUtils;
...
public final class SearchableConvertUtils {
     ...
     * value="com.uleehub.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
                ...
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [com.uleehub.common.entity.search.utils." +
